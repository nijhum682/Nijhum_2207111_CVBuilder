...
public class CvController {
    ...
    @FXML
    private Label fullNameLabel, fatherNameLabel, motherNameLabel, emailLabel, phoneLabel, addressLabel;

    @FXML
    private Label jscLabel, sscLabel, hscLabel;

    @FXML
    private Label skillsLabel, experienceLabel, projectsLabel;
